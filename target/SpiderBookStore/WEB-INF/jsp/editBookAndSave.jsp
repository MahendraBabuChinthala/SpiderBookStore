...
<div id="contact">
    ...
    <c:url value="/clientSideBookUpdateToServerSide" var="edit"/>
    <form:form method="post" action="${edit}" modelAttribute="bookDto">
        <table align="center">
            <tr>
                <td><label for="bookId">BOOK ID:</label></td>
                <td><form:input type="text" path="bookId" id="bookId"/></td>
                <td><form:errors path="bookId" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="bookName">Book Name:</label></td>
                <td><form:input type="text" path="bookName" id="bookName"/></td>
                <td><form:errors path="bookName" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="author">Book Author:</label></td>
                <td><form:input type="text" path="author" id="author"/></td>
                <td><form:errors path="author" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="description">Book Description:</label></td>
                <td><form:input type="text" path="description" id="description"/></td>
                <td><form:errors path="description" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="bookPrice">Book Price:</label></td>
                <td><form:input type="text" path="bookPrice" id="bookPrice"/></td>
                <td><form:errors path="bookPrice" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="publishYear">Book PublishYear:</label></td>
                <td><form:input type="date" path="publishYear" id="publishYear"/></td>
                <td><form:errors path="publishYear" cssClass="error"/></td>
            </tr>
            <tr></tr>
                <%-- <tr>
                     <td><label hidden for="sellerName">Book SellerName:</label></td>
                     <td><form:hidden type="text" path="sellerName" id="sellerName"/></td>
                     <td><form:errors path="sellerName" cssClass="error"/></td>
                 </tr>--%>
            <tr></tr>
            <tr>
                <td><label for="publication">Book Publication:</label></td>
                <td><form:input type="text" path="publication" id="publication"/></td>
...
<c:url value="/getSellerNameBooksData?email=${pageContext.request.userPrincipal.name}" var="previous"/>
<button class="button button1"><a href="${previous}">&laquo; Previous</a></button>
</body>
</html>
...
<div id="contact">
    ...
    <c:url value="/updateCustomerSave" var="updatecustomerSave"/>
    <form:form method="post" action="${updatecustomerSave}" modelAttribute="customerDto">
        <table align="center">
            <tr>
                <td><label for="firstName">FirstName* </label></td>
                <td>: <form:input type="text" path="firstName" id="firstName" placeholder="Enter your firstName"/>
                    <form:errors path="firstName" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="lastName">LastName* </label></td>
                <td>: <form:input type="text" path="lastName" id="lastName" placeholder="Enter your lastName"/>
                    <form:errors path="lastName" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="password">Password* </label></td>
                <td>: <form:input type="password" path="password" id="password" placeholder="Enter your password"/>
                    <form:errors path="password" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="rePassword">RePassword* </label></td>
                <td>: <form:input type="password" path="rePassword" id="rePassword"
                                  placeholder="Enter your rePassword"/>
                    <form:errors path="rePassword" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="dob">DateOfBirth* </label></td>
                <td>: <form:input type="date" path="dob" id="dob" placeholder="Enter your Date Of Birth"/>
                    <form:errors path="dob" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="contact">Contact* </label></td>
                <td>: <form:input type="text" path="contact" id="dob" placeholder="Enter your contact"/>
                    <form:errors path="contact" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="addressLine1">Address1* </label></td>
                <td>: <form:input type="textarea" path="addressLine1" id="addressLine1"
                                  placeholder="Enter Address(Area&Street)"/>
                    <form:errors path="addressLine1" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="addressLine2">Address2 </label></td>
                <td>: <form:input type="textarea" path="addressLine2" id="addressLine2"
                                  placeholder="Enter Address(Area&Street)"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="city">City* </label></td>
                <td>: <form:input type="" path="city" id="city" placeholder="City/District/Town"/>
                    <form:errors path="city" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="state">State* </label></td>
                <td>: <form:input type="" path="state" id="state" placeholder="Enter your state"/>
                    <form:errors path="state" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="pincode">Pincode* </label></td>
                <td>: <form:input type="" path="pincode" id="pincode" placeholder="Enter your pincode"/>
                    <form:errors path="pincode" cssClass="error"/></td>
            </tr>
            <tr>
                <td hidden><label for="role">Customer Role :</label></td>
            ...
            <tr></tr>
            <tr align="center">
                <td colspan="2"><input type="submit" class="btnregister" value="Edit Save"/></td>
            </tr>
        </table>
    </form:form>
</div>
<c:url value="/getSingleCustomer" var="singleCustomer"/>
<button class="button button1"><a href="${singleCustomer}">&laquo; Previous</a></button>
</body>
</html>

...
<div id="contact">
    ...
    <form:form method="post" action="saveCustomer" modelAttribute="customerDto">
        <table align="center">
            <tr>
            ...
            <tr>
                ...
                <td>: <form:input type="text" path="email" id="email" placeholder="Enter your email"/>
            ...
            <tr>
                    <%--<td><label for="bookId">Customer Role :</label></td>--%>
            ...
            <tr></tr>
            <tr align="center">
                <td colspan="2"><input type="submit" class="btnregister" value="Register"/></td>
            </tr>
        </table>
    </form:form>
</div>

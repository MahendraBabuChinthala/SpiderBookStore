...
<br>
<h1>Seller Portal Page</h1>
<h2>BOOKS LIST</h2>
<%-- book List --%>
<c:url value="/getBookByBookId/" var="getBook"/>
<div id="price">
        ...
        <div class="plan basic">
            <div class="plan-inner">
                ...
                <div class="entry-title">
                    <h3><a href="${getBook}/${book.bookId}">${book.bookName}</a></h3>
                    <div class="price">${book.bookPrice}<span>/PRICE</span>
                    </div>
                </div>
                <div class="entry-content">
                    <ul>
                        <li><a href="${getBook}/${book.bookId}"><strong>BookId</strong> : ${book.bookId}</a></li>
                ...
                <div class="btn">
                    <a href="${getBook}/${book.bookId}">Order Now</a>
                </div>
            </div>
        </div>
    </c:forEach>

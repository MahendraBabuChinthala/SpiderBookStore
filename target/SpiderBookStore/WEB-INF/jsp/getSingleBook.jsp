...
<header class="header-wrapper">
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <div class="dropdown" style="position: inherit">
            ...
            <c:url value="/getSingleCustomer" var="getCustomer"/>
...
<div id="contact">
    ...
    <c:url value="/checkOutPage" var="checkOutPage"/>
    <form:form action="${checkOutPage}" method="post" modelAttribute="bookDto">
        <table align="center">
            <tr>
            ...
            <tr>
                ...
                <td>: ${bookDto.publishYear}</td>
            </tr>
            <tr></tr>
            <tr>
                <td><label>SellerName </label></td>
                <td>: ${bookDto.sellerName}</td>
            </tr>
            <tr></tr>
            <tr>
                <td><label>Sublication </label></td>
                <td>: ${bookDto.publication}</td>
...
<div style="margin-left: 1073px;margin-top: 4px">
<c:url value="/addToCart?bookId=${bookDto.bookId}" var="cart"/>
<button class="button button1"><a href="${cart}">Add To Cart</a></button>
</div>
</body>
</html>

...
<html>
<head>
    <title>Add Book Form Page</title>
    <style>
        #contact {
            width: 430px;
            margin: 60px auto;
...
<%-- Navigation Bar --%>
<c:url value="/getSellerNameBooksData" var="sellerBooks"/>
...
<div class="navbar">
    <div class="navbar-link-holder">
        ...
        <a href="${sellerBooks}" style="margin-left: 80px">Your Books List</a>
...
<div id="contact">
    <h1>Add Book Form</h1>
    <form:form method="post" action="clientSideBookAddToServerSide" modelAttribute="bookDto">
        <table align="center">
            <tr>
                <td><label for="bookId">BOOK ID:</label></td>
                <td><form:input type="text" path="bookId" id="bookId" placeholder="Enter your bookId"/>
                    <form:errors path="bookId" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="bookName">Book Name:</label></td>
                <td><form:input type="text" path="bookName" id="bookName" placeholder="Enter your bookName"/>
                    <form:errors path="bookName" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="author">Book Author:</label></td>
                <td><form:input type="text" path="author" id="author" placeholder="Enter your bookAuthor"/>
                    <form:errors path="author" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="description">Book Description:</label></td>
                <td><form:input type="text" path="description" id="description"
                                placeholder="Enter your bookBescription"/>
                    <form:errors path="description" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="bookPrice">Book Price:</label></td>
                <td><form:input type="text" path="bookPrice" id="bookPrice" placeholder="Enter your bookPrice"/>
                    <form:errors path="bookPrice" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr>
                <td><label for="publishYear">Book PublishYear:</label></td>
                <td><form:input type="date" path="publishYear" id="publishYear"
                                placeholder="Enter your bookPublishYear"/>
                    <form:errors path="publishYear" cssClass="error"/></td>
            </tr>
            <tr></tr>
                <%--<tr>
                    <td><label for="sellerName">Book SellerName:</label></td>
                    <td><form:input type="text" path="sellerName" id="sellerName" placeholder="Enter your bookSellerName"/>
                        <form:errors path="sellerName" cssClass="error"/></td>
                </tr>--%>
            <tr></tr>
            <tr>
                <td><label for="publication">Book Publication:</label></td>
                <td><form:input type="text" path="publication" id="publication"
                                placeholder="Enter your bookPublication"/>
                    <form:errors path="publication" cssClass="error"/></td>
            </tr>
            <tr></tr>
            <tr></tr>
            <tr></tr>
            <tr></tr>
            <tr align="center">
                <td colspan="2"><input type="submit" value="Book Submit" class="btnRegister"/></td>
            </tr>
        </table>
    </form:form>
</div>
<br>
<c:url value="/sellerPortal" var="sellerPortal"/>
<button class="button button1"><a href="${sellerPortal}">&laquo; Previous</a></button>
</body>
</html>
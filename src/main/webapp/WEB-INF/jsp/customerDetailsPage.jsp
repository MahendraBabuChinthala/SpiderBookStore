...
<div id="contact">
    ...
    <form:form method="post" modelAttribute="customerDto">
        <table align="center">
            <tr>
            ...
            <tr>
                ...
                <td>: ${customerDto.dob}</td>
            </tr>
            <tr></tr>
            <tr>
                <td><label>addressLine1 </label></td>
                <td>: ${customerDto.addressLine1}</td>
            </tr>
            <tr></tr>
            <tr>
                <td><label>addressLine2 </label></td>
                <td>: ${customerDto.addressLine2}</td>
            </tr>
            <tr></tr>
            <tr>
            ...
            <tr>
                ...
                <td>: ${customerDto.pincode}</td>
            </tr>
            <tr></tr>
            <tr></tr>
            <tr>
                <td align="center">
                    <c:url value="/updateCustomer" var="Edit"/>
                    <button class="button button1"><a href="${Edit}">Edit</a></button>
                </td>
                <c:url value="/deleteCustomer?email=${customerDto.email}" var="delete"/>
                <td align="center" hidden>
                    <button class="button button2"><a href="${delete}">Delete</a></button>
                </td>
            </tr>
            <tr></tr>
        </table>
...
<c:url value="/customerHome" var="home"/>
<h3 style="margin-left: 10px;margin-top: -709px;">

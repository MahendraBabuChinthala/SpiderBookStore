...
<body>
<%--<c:url value="/allBookCartData" var="cartList"/>
<i class='fas fa-shopping-bag' style='font-size:48px;color:#293991'/><a href="${cartList}" style="margin-left: 50px;color: #293991">MY CART</a>--%>
...
<table>
    <tr>
        <td colspan="2"><img
                src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1612371216829_toys-1920.webp"
                style="width:100%;height:100px;margin-top: 0px"></td>
    </tr>
</table>
<div></div>
<br>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1616413873522_spotlight-food.webp"
                 class=" w-100 " alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1616413917113_spotlight-gopichand.webp"
                 class=" w-100 " alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1617194704666_spotlight-sita.webp"
                 class="d-block w-100" alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1616414014789_spotlight-world.webp"
                 class="d-block w-100" alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="https://s3-ap-southeast-1.amazonaws.com/filehost.sapnaonline.com/widgets/1617194664787_spotlight-everything.webp"
                 class="d-block w-100" alt="Error loading image">
            <div class="carousel-caption d-none d-md-block">
            </div>
        </div>
...
<br>
<div></div>
<h3 style="color:lightseagreen "><p align="center">Books List
    <p></p></h3>
<%-- List of Books Data --%>
<div id="price">
    <!--price tab-->
        ...
        <div class="plan">
            <div class="plan-inner">
                <div class="entry-title">
                    ...
                    <div class="price">${book.bookPrice}<span> / PRICE</span>
                    </div>
                </div>
                <div class="entry-content">
                    <ul>
                        <li></li>
                        <li><a href="getBookByBookId/${book.bookId}"><strong>BookId </strong> : ${book.bookId}</a></li>
                        <li><strong>Author</strong> : ${book.author}</li>
                        <li></li>
                    </ul>
                </div>
                <div class="btn">
<%--                    <c:url value="/getBookByBookId/${book.bookId}" var="BUY"/>--%>
                    <c:url value="/getBookByBookId/${book.bookId}" var="BUY"/>
                    <c:url value="/addToCart?bookId=${book.bookId}" var="cart"/>
